...
type GreeterClient interface {
	...
	PostStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[StreamReqData, StreamResData], error)
...
func (c *greeterClient) PostStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[StreamReqData, StreamResData], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_PostStreamClient = grpc.ClientStreamingClient[StreamReqData, StreamResData]
...
type GreeterServer interface {
	...
	PostStream(grpc.ClientStreamingServer[StreamReqData, StreamResData]) error
...
func (UnimplementedGreeterServer) PostStream(grpc.ClientStreamingServer[StreamReqData, StreamResData]) error {
...
func _Greeter_PostStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).PostStream(&grpc.GenericServerStream[StreamReqData, StreamResData]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_PostStreamServer = grpc.ClientStreamingServer[StreamReqData, StreamResData]
